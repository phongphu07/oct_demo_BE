...
class CombinedPipeline:
    ...
    def process_dicom_and_predict(self, dicom_file, excel_file, output_path):
        ...
        # Step 3: Phát hiện tổn thương
        detection_results = self.detect_lesions(segmented_frame, output_path)
...
dicom_file = './example_image/model3/F213-RCA(1)_anon.dcm'
excel_file = './example_image/model3/FFR_Regression_Test_F300_LAD5.xlsx'
